...
namespace PieceTree.TextBuffer.Core
{
    ...
    public class ReplacePiece
    {
        ...
        public override bool Equals(object? obj)
        {
            ...
            {
                if (StaticValueData != other.StaticValueData) return false;
                if (MatchIndexValue != other.MatchIndexValue) return false;
                
                if (CaseOpsValue == null && other.CaseOpsValue == null) return true;
                if (CaseOpsValue == null || other.CaseOpsValue == null) return false;
                if (CaseOpsValue.Length != other.CaseOpsValue.Length) return false;
                
                for (int i = 0; i < CaseOpsValue.Length; i++)
                {
                    if (CaseOpsValue[i] != other.CaseOpsValue[i]) return false;
                }
                return true;
            }
            return false;
    ...
    public class ReplacePattern
    {
        ...
        {
            return new ReplacePattern(new[] { ReplacePiece.StaticValue(value) });
        }
            ...
            for (int index = 0; index < splitPatternAtSpecialCharacter.Length; index++)
            {
                replaceString.Append(
                    BuildReplaceStringWithCasePreserved(
                        new[] { splitMatchAtSpecialCharacter[index] }, 
        ...
        public override bool Equals(object? obj)
        {
            if (obj is ReplacePattern other)
            {
                ...
                {
                    if (_pieces == null && other._pieces == null) return true;
                    if (_pieces == null || other._pieces == null) return false;
                    if (_pieces.Length != other._pieces.Length) return false;
                    
                    for (int i = 0; i < _pieces.Length; i++)
                    {
                        if (!_pieces[i].Equals(other._pieces[i])) return false;
                    }
                    return true;
                }
            }
