...
| CL4 | Decorations、IntervalTree stickiness、Markdown DocUI rendering semantics（TS `textModelDecorations.ts`、`modelDecorations.ts`、`markdownRenderer.ts`） | `agent-team/handoffs/AA3-007-Audit.md` | `agent-team/handoffs/AA3-008-Result.md` | `DecorationTests`、`MarkdownRendererTests`（AA3-009 QA · `dotnet test tests/TextBuffer.Tests/TextBuffer.Tests.csproj` → 88/88） | Audit Complete – Fixes Landed | [`AA3-007-Audit`](../../agent-team/handoffs/AA3-007-Audit.md)<br>[`AA3-008-Result`](../../agent-team/handoffs/AA3-008-Result.md)<br>[`AA3-009-QA`](../../agent-team/handoffs/AA3-009-QA.md) |
...
- **Validation Hooks:** `TextModelTests` + `TextModelSearchTests` （`dotnet test tests/TextBuffer.Tests/TextBuffer.Tests.csproj`）。
...
- **Porter Result:** `agent-team/handoffs/AA3-008-Result.md` lands the TS decoration trees, `DecorationRangeUpdater`, metadata-rich `OnDidChangeDecorations` events, new helper queries, and a Markdown renderer that honors owner filters, injected text, glyph/margin/minimap/overview annotations, and z-index ordering.
- **Validation Hooks:** AA3-009 QA（2025-11-20）新增 injected text/margin/font queries、`forceMoveMarkers` stickiness parity与 DocUI diff markers 覆盖；`dotnet test tests/TextBuffer.Tests/TextBuffer.Tests.csproj`（88/88）。详情见 [`agent-team/handoffs/AA3-009-QA.md`](../../agent-team/handoffs/AA3-009-QA.md)，同一 changefeed 仍引用 [`agent-team/indexes/README.md#delta-2025-11-20`](../../agent-team/indexes/README.md#delta-2025-11-20)。
