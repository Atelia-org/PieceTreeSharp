...
| P0 | AA3-003 | Porter-CS：根据 CL1 结论执行 TextModel/Options 修复，记录在 `agent-team/handoffs/AA3-003-Result.md` + 迁移日志。 | 3 | Porter-CS | 2025-11-24 | AA3-001 | Done – `agent-team/handoffs/AA3-003-Result.md` + `dotnet test src/PieceTree.TextBuffer.Tests/PieceTree.TextBuffer.Tests.csproj`（79/79）并已在 `agent-team/indexes/README.md#delta-2025-11-20` 备案 |
...
| P1 | AA3-008 | Porter-CS：根据 CL4 结论修复 Decorations/DocUI。 | 3 | Porter-CS | 2025-11-25 | AA3-007 | Done – `agent-team/handoffs/AA3-008-Result.md` + `dotnet test src/PieceTree.TextBuffer.Tests/PieceTree.TextBuffer.Tests.csproj`（85/85），DocUI closure由 `agent-team/handoffs/AA3-009-QA.md` 与 changefeed `agent-team/indexes/README.md#delta-2025-11-20` 佐证 |
| P0 | AA3-009 | QA-Automation：扩展 `TextModelTests`/`PieceTreeSearchTests`/`DiffTests`/`DecorationTests`/`MarkdownRendererTests` 以覆盖新语义，并记录 `dotnet test ...` 最新基线。 | 2 | QA-Automation | 2025-11-26 | AA3-003~008 | Done – `agent-team/handoffs/AA3-009-QA.md` 记录 CL4 decoration metadata + DocUI diff snapshots（`dotnet test src/PieceTree.TextBuffer.Tests/PieceTree.TextBuffer.Tests.csproj` 88/88；changefeed 引用 `agent-team/indexes/README.md#delta-2025-11-20`）。 |
...
- 2025-11-20：AA3-009（QA）完成 —— `agent-team/handoffs/AA3-009-QA.md` 覆盖 injected text/margin/font queries、`forceMoveMarkers` parity 与 DocUI diff markers；`docs/reports/audit-checklist-aa3.md#cl4`、`src/PieceTree.TextBuffer.Tests/TestMatrix.md`、`AGENTS.md`、`agent-team/task-board.md`、`docs/sprints/sprint-01.md` 更新一致；`dotnet test src/PieceTree.TextBuffer.Tests/PieceTree.TextBuffer.Tests.csproj`（88/88，changefeed 仍引用 `agent-team/indexes/README.md#delta-2025-11-20`）。
