...
{
    public static PieceTreeScriptStep[] CrlfRandomBug01 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CrlfRandomBug02 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CrlfRandomBug03 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CrlfRandomBug04 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CrlfRandomBug05 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CrlfRandomBug06 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CrlfRandomBug07 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CrlfRandomBug08 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CrlfRandomBug09 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CrlfRandomBug10 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomBug01 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomBug02 { get; } =
    [
        InsertStep(2, "\n\r\r\r", "cls-random-bug2-insert-1"),
        DeleteStep(4, 1, "cls-random-bug2-delete-1"),
    ];

    public static PieceTreeScriptStep[] CentralizedLineStartsRandomBug03 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomBug04 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomBug05 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomBug06 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomBug07 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomBug08 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomBug09 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomBug10 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomChunkBug01 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomChunkBug02 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomChunkBug03 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] CentralizedLineStartsRandomChunkBug04 { get; } =
    [
    ...
    public static PieceTreeScriptStep[] SearchOffsetRenderWhitespace { get; } =
    [
    ...
    public static PieceTreeScriptStep[] SearchOffsetNormalizedEolCase1 { get; } =
    [
        InsertStep(3, "def\nabc", "search-offset-norm-case1-insert-1"),
    ];

    public static PieceTreeScriptStep[] SearchOffsetNormalizedEolCase2 { get; } =
    [
        InsertStep(4, "def\nabc", "search-offset-norm-case2-insert-1"),
    ];

    public static PieceTreeScriptStep[] SearchOffsetNormalizedEolCase3 { get; } =
    [
        InsertStep(2, "def\nabc", "search-offset-norm-case3-insert-1"),
    ];

    public static PieceTreeScriptStep[] SearchOffsetNormalizedEolCase4 { get; } =
    [
