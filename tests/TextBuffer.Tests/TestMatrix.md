...
**Total Tests Passing**: 365 (`export PIECETREE_DEBUG=0 && dotnet test tests/TextBuffer.Tests/TextBuffer.Tests.csproj --nologo`, 61.6s, 2025-11-26 Sprint 03 Run R37 — tagged `#delta-2025-11-25-b3-textmodelsearch`, evidence in `agent-team/handoffs/B3-TextModelSearch-QA.md`; targeted TextModelSearch rerun 45/45 green, 2.5s, same handoff)
**Date**: 2025-11-26
