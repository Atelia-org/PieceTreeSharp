...
| TextModelSearchTests | Regex/word search parameters, CRLF payloads, `parseSearchRequest` + navigation parity | [ts/src/vs/editor/test/common/model/textModelSearch.test.ts](../../ts/src/vs/editor/test/common/model/textModelSearch.test.ts) | B | Verified (Sprint 03 R36 – parseSearchRequest + navigation) | `#delta-2025-11-25-b3-textmodelsearch`: Investigator brief [`Review-20251125-Investigator.md`](../../agent-team/handoffs/Review-20251125-Investigator.md) + Porter memo [`B3-TextModelSearch-PORT.md`](../../agent-team/handoffs/B3-TextModelSearch-PORT.md) confirm `SearchPatternUtilities.IsMultilineRegexSource` landed and the TS 45-case battery now lives here. Latest QA `export PIECETREE_DEBUG=0 && dotnet test tests/TextBuffer.Tests/TextBuffer.Tests.csproj --filter FullyQualifiedName~TextModelSearchTests --nologo` → 45/45 green (2.0s). Backlog: Intl.Segmenter word segmentation + WordSeparator cache perf remain open. |
...
| --- | ---: | ---: | ---: | ---: | --- |
| 2025-11-25 (B3-TextModelSearch QA R36) | 355 | 355 | 0 | 64.3s | `export PIECETREE_DEBUG=0 && dotnet test tests/TextBuffer.Tests/TextBuffer.Tests.csproj --nologo` — Full sweep covering the Issue #53415 fix; evidence logged for `#delta-2025-11-25-b3-textmodelsearch`. |
...
| `export PIECETREE_DEBUG=0 && dotnet test tests/TextBuffer.Tests/TextBuffer.Tests.csproj --filter TextModelSearchTests --nologo` | 45/45 green (2.0s) | Replays the entire TextModelSearch battery after the new `parseSearchRequest` + navigation suites landed; logged for `#delta-2025-11-25-b3-textmodelsearch`. |
