...
public class PieceTreeBaseTests
{
    ...
    {
        PieceTreeBuffer buffer = new("This is a document with some text.");
    ...
    {
        PieceTreeBuffer buffer = new("012345678");
    ...
    {
        PieceTreeBuffer buffer = new("Line 1\nLine 2\nLine 3");

        // Cache miss -> load
        string line2 = buffer.GetLineContent(2);
        ...
        string line2Modified = buffer.GetLineContent(2);
