...
| PT-004 | Port RBTree skeleton to C# | Porter-CS | `src/PieceTree.TextBuffer/Core` | 2 | In Progress | `src/PieceTree.TextBuffer/README.md#porting-log` (2025-11-19 G1: PieceTreeBuilder wiring + search stub TODO) |
