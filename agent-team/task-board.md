...
| PT-004 | Port RBTree skeleton to C# | Porter-CS | `src/PieceTree.TextBuffer/Core` | 2 | Done | `docs/reports/migration-log.md` (2025-11-19 PT-011 Verified) |
| PT-005 | Draft QA test matrix & perf plan | QA-Automation | `src/PieceTree.TextBuffer.Tests/UnitTest1.cs`<br>`src/PieceTree.TextBuffer.Tests/TestMatrix.md` | 1 | Done | `src/PieceTree.TextBuffer.Tests/TestMatrix.md` (2025-11-19 PT-011 Verified) |
...
| PT-011 | Consolidate PT-004/PT-005 & Finalize v1 | QA-Automation | `src/PieceTree.TextBuffer.Tests/TestMatrix.md` | 1 | Done | `docs/reports/migration-log.md` (2025-11-19 PT-011 Verified) |
