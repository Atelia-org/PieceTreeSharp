...
| PT-003 | Expand TS↔C# type mapping | Investigator-TS | `agent-team/type-mapping.md` | 1 | In Progress | `AGENTS.md#最新进展` (type-mapping draft logged 2025-11-19) |
| PT-004 | Port RBTree skeleton to C# | Porter-CS | `src/PieceTree.TextBuffer/Core` | 2 | Planned | `AGENTS.md#最新进展` (C# skeleton placeholder 2025-11-19) |
| PT-005 | Draft QA test matrix & perf plan | QA-Automation | `src/PieceTree.TextBuffer.Tests/UnitTest1.cs` | 1 | Planned | `docs/sprints/sprint-00.md#backlog-snapshot` (P2 planned) |
