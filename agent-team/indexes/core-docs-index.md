...
| --- | --- | --- | --- | --- |
| AGENTS.md | 记录跨会话记忆、里程碑与工具约束，用作全局时间线与工作记忆入口。 | Main Agent / DocMaintainer | 2025-11-19 | `AGENTS.md` |
...
| Task Board | 追踪 PT/OI 任务状态、runSubAgent 预算与备注，是工作调度事实表。 | Planner（各 Owner 更新） | 2025-11-19 | `agent-team/task-board.md` |
