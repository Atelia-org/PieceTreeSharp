...
- Remaining TODOs:
   ...
   2. Capture TRX artifacts + clipboard guard toggling logs for DocUI-specific runs to ease future regressions (planned under `TestResults/docui/` once overlay drops land).
